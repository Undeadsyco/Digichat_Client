...
const mapDispatchToProps = (dispatch) => {
  const { sendToken, sendTokenCompleted, signup, signupCompleted, login, loginCompleted, logout, logoutCompleted } = userActions;
  return {
    onSendToken: () => sendToken().then(data => {
      console.log('data in app', data)
      dispatch(sendTokenCompleted(data))
    }),
...
const mapStateToProps = (state) => {
  const { other, user: { actions }} = state;
  return {
    ...
    profilePosts: other.profilePosts,
