...
import { authAxios, mapFunctions } from '.';
...
const mapUser = (data) => {
  const user = {
    ...
    email: data.Email,
    admin: data.Admin,
    friends: this.mapFriends(data.Friends),
    requests: this.mapRequests(data.Requests),
...
export const getUsers = async () => {
  const req = await axios.get('/api/v2/users/others/api')
...
export const getPosts = async () => {
  const req = await axios.get('/api/v2/posts/api')
  const res = await req.data
...
export const makePost = async (object) => {
  const req = await authAxios.post('/api/v2/posts/api', object)
  const res = await req.data
...
export const editPost = async (obj) => {
  const req = await authAxios.put(`/api/v2/posts/api/edit`, obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return {
    status: res.status,
...
export const updateVotes = async (type, current, postId) => {
  if (type === 'likes') {
    const req = await axios.put(`/api/v2/posts/api/${type}/${postId}`, { likes: current })
    const res = await req.data
    const posts = mapPosts(res)
    return posts.reverse()
  }
  if (type === 'dislikes') {
    const req = await axios.put(`/api/v2/posts/api/${type}/${postId}`, { dislikes: current })
    const res = await req.data
    const posts = mapPosts(res)
    return posts.reverse()
  }
...
export const deletePost = async (postId) => {
  const req = await authAxios.delete(`/api/v2/posts/api/${postId}`)
  const res = await req.data
  const posts = mapPosts(res.data)
  return {
    status: res.status,
...
export const makeComment = async (obj) => {
  const req = await authAxios.post('/api/v2/comments/api', obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const updateCommentVotes = async (type, current, commentId) => {
  if (type === 'likes') {
    const req = await axios.put(`/api/v2/comments/api/${type}/${commentId}`, { likes: current })
    const res = await req.data
    const posts = mapPosts(res.data)
    return posts.reverse()
  }
  if (type === 'dislikes') {
    const req = await axios.put(`/api/v2/comments/api/${type}/${commentId}`, { dislikes: current })
    const res = await req.data
    const posts = mapPosts(res.data)
    return posts.reverse()
  }
...
export const deleteComment = async (obj) => {
  let { commentId } = obj
  const req = await authAxios.delete(`/api/v2/comments/api/${commentId}`)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
const getProfileById = async (userId) => {
  const req = await authAxios.get(`/api/v2/users/others/api/profile/${userId}`)
  const res = await req.data
  console.log(res)
...
export const makePostByUserId = async (obj) => {
  const req = await authAxios.post(`/api/v2/posts/api/${obj.userId}`, obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const editPostByUserId = async (obj) => {
  const req = await authAxios.put(`/api/v2/posts/api/${obj.userId}`, obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const updateVotesByUserId = async (type, current, userId, postId) => {
  if (type === 'likes') {
    const req = await axios.put('/api/v2/posts/api/user/profile/votes', {
      type: type,
      postId: postId,
      userId: userId,
      likes: current
...
export const deletePostByUserId = async (postId, userId) => {
  const req = await authAxios.delete(`/api/v2/posts/api/${postId}/${userId}`)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const makeCommentByUserId = async (obj) => {
  const req = await authAxios.post(`/api/v2/comments/api/${obj.profileId}`, obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const updateCommentVotesByUserId = async (obj) => {
  ...
  if (type === 'likes') {
    const req = await axios.put(`/api/v2/comments/api/update/votes/${commentId}`, {
      type: type,
      userId: userId,
      likes: current
    })
...
export const deleteCommentByUserId = async (obj) => {
  ...
  const req = await authAxios.delete(`/api/v2/comments/api/${commentId}/${userId}`)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const getAllGroups = async () => {
  const req = await authAxios.get('/api/v2/groups/api/groups')
  const res = await req.data
...
export const createGroup = async (obj) => {
  const req = await authAxios.post('/api/v2/groups/api/create', obj)
  const res = await req.data
  const groups = mapGroups(res)
  return groups
}
...
const getGroupById = async (groupId) => {
  const req = await authAxios.get(`/api/v2/groups/api/groups/${groupId}`)
  const res = await req.data
...
const getGroupPosts = async (groupId) => {
  const req = await authAxios.get(`/api/v2/posts/api/groupPost/${groupId}`)
  const res = await req.data
  const posts = mapPosts(res)
  return posts.reverse()
}
...
export const joinGroup = async (obj) => {
  const req = await authAxios.post('/api/v2/groups/api/join', obj)
  const res = await req.data
...
export const leaveGroup = async (obj) => {
  const req = await authAxios.delete(`/api/v2/groups/api/leave/${obj.groupId}/${obj.userId}`)
  const res = await req.data
  const group = mapGroup(res)
  return group
}
...
export const editGroupDescription = async (obj) => {
  const req = await authAxios.put('/api/v2/groups/api/discription', obj)
  const res = await req.data
  const group = mapGroup(res)
  return group
}
...
export const updateGroupVotes = async (obj) => {
  const req = await authAxios.put('/api/v2/groups/api/groupPage/votes', obj)
  const res = await req.data
  const group = mapGroup(res)
  return group
}
...
export const disbandGroup = async (obj) => {
  const req = await authAxios.delete(`/api/v2/groups/api/disband/${obj}`)
  const res = await req.data
  return res
}
...
export const createGroupPost = async (obj) => {
  console.log(obj)
  const req = await authAxios.post('/api/v2/posts/api/groupPosts/create', obj)
  const res = await req.data
  const posts = mapPosts(res)
  return posts.reverse()
}
...
export const deleteGroupPost = async (obj) => {
  ...
  const req = await authAxios.delete(`/api/v2/posts/api/groupPost/${groupId}/${postId}`)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const editGroupPost = async (obj) => {
  const req = await authAxios.put('/api/v2/posts/api/groupPost/edit/post', obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const updateGroupPostVotes = async (obj) => {
  const req = await authAxios.put('/api/v2/posts/api/groupPost/edit/votes', obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const makeGroupComment = async obj => {
  const req = await authAxios.post('/api/v2/comments/api/groupComments/create', obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const updateGroupCommentVotes = async obj => {
  const req = await authAxios.put('/api/v2/comments/api/groupComments/update/votes', obj)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const deleteGroupComment = async obj => {
  ...
  const req = await authAxios.delete(`/api/v2/comments/api/groupComments/delete/${commentId}/${groupId}`)
  const res = await req.data
  const posts = mapPosts(res.data)
  return posts.reverse()
}
...
export const removeUser = async obj => {
  ...
  const req = await authAxios.delete(`/api/v2/groups/api/remove/${groupId}/${userId}`)
  const res = await req.data
  console.log(res)
  const group = mapGroup(res.data)
  return group
...
export const makeGroupAdmin = async obj => {
  const req = await authAxios.put('/api/v2/groups/api/groups/groupAdmin', obj)
  const res = await req.data
  const group = mapGroup(res.data)
  return group
}
...
export const removeGroupAdmin = async obj => {
  const req = await authAxios.put('/api/v2/groups/api/groups/remove/admin', obj)
  const res = await req.data
  const group = mapGroup(res.data)
  return group
}
...
export const transferGroupOwner = async obj => {
  const req = await authAxios.put('/api/v2/groups/api/groups/make/owner', obj)
  const res = await req.data
  const group = mapGroup(res.data)
  return group
}
...
export const addFriend = async obj => {
  const req = await authAxios.post('/api/v2/users/users/api/add/friend', obj)
  const res = await req.data
...
export const cancelFriend = async obj => {
  const req = await authAxios.delete(`/api/v2/users/users/api/cancel/friend/${obj}`)
  const res = await req.data
  const user = mapUser(res.data)
  return user
}
...
export const acceptRequest = async obj => {
  const req = await authAxios.post('/api/v2/users/users/api/accept/request', obj)
  const res = await req.data
  const user = mapUser(res.data)
  return user
}
...
export const denyRequest = async obj => {
  const req = await authAxios.put('/api/v2/users//api/deny/request', obj)
  const res = await req.data
  const user = mapUser(res.data)
  return user
}
...
export const confirmNotification = async obj => {
  const req = await authAxios.put('/api/v2/users/users/api/confirm/notification', obj)
  const res = await req.data
  const user = mapUser(res.data)
  return user
}
...
export const removeFriend = async obj => {
  const req = await authAxios.delete(`/api/v2/users/users/api/remove/friend/${obj}`)
  const res = await req.data
  const user = mapUser(res.data)
  return user
}